...
const PageViewDoctor = () => {
    ...
    const handleRedirectDoctor = (item, thoiGianKhamBenh, listTime) => {
        navigate(
            `/page-dat-lich-kham?id=${item._id}&idGioKhamBenh=${thoiGianKhamBenh}&ngayKham=${listTime}`
        );
    };
            ...
            <div className="layout-app">
                        ...
                        <Row>
                            ...
                            >
                                ...
                                >
                                    ...
                                    bệnh lý <br />
                                    Bác sĩ nhận khám cho bệnh nhân từ 16 tuổi
                                    trở lên
                                </p>
                                <p
                                    style={{
                        ...
                        <Row>
                            <Col
                                ...
                                style={{
                                    backgroundColor: "white",
                                    borderRight:
                                        "1px solid rgba(228, 228, 221, 0.637)",
                                }}
                            >
                                <Col
                                    span={24}
                                ...
                                >
                                    ...
                                    >
                                        Chọn <FaRegHandPointUp size={14} /> và
                                        đặt (Phí đặt lịch 0đ)
                                    </p>
                                </Col>
                            </Col>
                            ...
                            >
                                ...
                                <p style={{ fontWeight: "500" }}>
                                    Phòng khám {dataDoctor?.phongKhamId.name}{" "}
                                    Bác sĩ {dataDoctor?.lastName}{" "}
                                    {dataDoctor?.firstName}
                                </p>
                                    ...
                                    <div>
                                        ...
                                        >
                                            <span className="span-gia-kham">
                                                ...
                                                >
                                                    Giá khám cho người Việt
                                                </p>
                                                <p>
                                                    Giá khám chưa bao gồm chi
                                                    phí chụp chiếu, xét nghiệm
                                                </p>
                                            </span>
                                            <span
                                                style={{
                ...
                <Row>
                    <Col
                        ...
                        style={{
                            backgroundColor: "#f7f7f7",
                            borderTop: "1px solid rgba(228, 228, 221, 0.637)",
                            marginTop: "20px",
                        }}
                    >
                        <Row>
