...
const ModalCauHoi = (props) => {
    ...
    const submitCauHoi = async (values) => {
        const { lastName, firstName, email, chuyenKhoaId, cauHoi } = values;
        ...
        setLoading(true);
        let res = await handleCreateCauHoi(
            email,
            firstName,
            lastName,
            chuyenKhoaId,
    ...
    return (
        ...
        >
            <Divider />
            <Form form={form} layout="vertical" onFinish={submitCauHoi}>
                <Row gutter={[20, 2]}>
                    ...
                    >
                        <Button
                            ...
                            type="primary"
                            size="large"
                            icon={<FaRegCircleQuestion size={25} />}
                        >
                            Tạo câu hỏi
                        </Button>
                    </Col>
