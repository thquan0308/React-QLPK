                ...
                <Row>
                    <Col xs={24} sm={12} md={24} span={24}>
                        ...
                        >
                            ...
                            <ColumnGroup
                                title={
                                    <p className="title-col-style">Họ và Tên</p>
                                }
                            >
                                <Column
                                    title={
                                        <p className="title-col-style">Họ</p>
                                    }
                                    dataIndex="lastName"
                                    key="lastName"
                                />
                                <Column
                                    title={
                                        <p className="title-col-style">Tên</p>
                                    }
                                    dataIndex="firstName"
                                    key="firstName"
                                />
                            ...
                            <Column
                                title={
                                    <p className="title-col-style">Địa chỉ</p>
                                }
                                dataIndex="address"
                                key="address"
                                width={200}
                            ...
                            <Column
                                title={
                                    <p className="title-col-style">Chức năng</p>
                                }
                                key="action"
                                render={(_, record) => (
                                    <Space size="middle">
