...
const ViewLichHen = (props) => {
    ...
    const items = [
        ...
        //             {Math.ceil(dataViewDH?.giaKham).toLocaleString()} VNĐeeee
        //         </span>
        //     ),
        //     span: 2,
        // },
    ...
    return (
        ...
        >
            <Descriptions
                title={`Chi tiết lịch hẹn của tài khoản đã đặt: ${dataViewDH?._idTaiKhoan?.lastName} ${dataViewDH?._idTaiKhoan?.firstName} (${dataViewDH?._idTaiKhoan?.email})`}
                bordered
                items={items}
            />
        </Drawer>
